...
import { ImageInfo, RequestSchema, ToolEnum, LayoutEnum, ViewerModule } from 'ng-cornerstone';
...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //   // urlRoot: 'http://localhost:8042/dicom-web/',
    ...
    //   // urlRoot:
    //   //   'http://127.0.0.1:8080/ABD_LYMPH_006/fe0ace7a-b70a-43bc-9eb0-52359b4d2241/Images/ABD_LYMPH_006.nii.gz',
    //   // urlRoot: 'http://127.0.0.1:8080/referenceT1.nii',
    //   // urlRoot:
    //   //   'http://127.0.0.1:8080/ABD_LYMPH_006/fe0ace7a-b70a-43bc-9eb0-52359b4d2241/Images/ABD_LYMPH_006.nii',
    //   // urlRoot:
    //   //   'http://127.0.0.1:8080/ABD_LYMPH_006/fe0ace7a-b70a-43bc-9eb0-52359b4d2241/Labels/20231211-035637/ABD_LYMPH_006.nii',
    ...
    setTimeout(() => {
      this.imageInfo = {
        ...
        // urlRoot: 'http://localhost:5000/api/image?path=0000008839/image.nii.gz',
        urlRoot:
          'http://127.0.0.1:8080/segment/ABD_LYMPH_078/b1d8ef93-22c5-41cc-b3c8-a8a14ec37af8/Images/ABD_LYMPH_078.nii.gz',
        // urlRoot:
        //   'http://127.0.0.1:8080/ABD_LYMPH_006/fe0ace7a-b70a-43bc-9eb0-52359b4d2241/Images/ABD_LYMPH_006.nii.gz',
        // urlRoot: 'http://127.0.0.1:8080/referenceT1.nii',
        // urlRoot:
  ...
  segmentInfos: ImageInfo[] = [
    {
      urlRoot:
        'http://127.0.0.1:8080/segment/MED_LYMPH_089/ec0976c5-4926-4434-87bc-7b591f8f4b63/Labels/20231211-035627/MED_LYMPH_089.nii.gz',
      viewportType: csCoreEnum.ViewportType.ORTHOGRAPHIC,
      schema: RequestSchema.nifti,
      segmentType: csToolEnum.SegmentationRepresentations.Labelmap,
    },
    ...
    {
      urlRoot:
        'http://127.0.0.1:8080/nifti/minivna_data/spleen_2_1/c797483d-0aa0-40ca-a41b-84f6333687b6/e87971ff-0fa5-4189-8208-8dee2b3b6c9e/Labels/20230928-133709/spleen_2.nii.gz',
      viewportType: csCoreEnum.ViewportType.ORTHOGRAPHIC,
      schema: RequestSchema.nifti,
      segmentType: csToolEnum.SegmentationRepresentations.Labelmap,
    },
  ...
  imageInfos: ImageInfo[] = [
    ...
    {
      urlRoot:
        'http://127.0.0.1:8080/segment/MED_LYMPH_089/ec0976c5-4926-4434-87bc-7b591f8f4b63/Images/MED_LYMPH_089.nii.gz',
      viewportType: csCoreEnum.ViewportType.ORTHOGRAPHIC,
      schema: RequestSchema.nifti,
    },
    {
    ...
    {
      urlRoot:
        'http://127.0.0.1:8080/nifti/minivna_data/spleen_2_1/c797483d-0aa0-40ca-a41b-84f6333687b6/e87971ff-0fa5-4189-8208-8dee2b3b6c9e/Images/spleen_2_1.nii.gz',
      viewportType: csCoreEnum.ViewportType.ORTHOGRAPHIC,
      schema: RequestSchema.nifti,
    },
  ];
